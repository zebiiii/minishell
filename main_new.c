...
/*   Updated: 2022/06/21 14:13:03 by mgoudin          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	execution_path(t_list **head, t_data *data, t_redirect *tab)
{
	char	*res;
...
void	ft_init_lst(t_list **head, t_data *data)
{
	t_list	*lst;
